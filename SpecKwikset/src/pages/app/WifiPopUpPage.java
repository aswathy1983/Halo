...
public class WifiPopUpPage extends Settings{
	...
	String actTitle, actMessage ="";
		...
		public WifiPopUpPage(AppiumDriver<MobileElement> driver) {
		...
		public void clickCancelButton() {
			try {
				...
				Log.addMessage("Failed to display pop up.");
				Assert.assertTrue(false, "Failed to display pop up.");
			}
		}
		...
		public void verifyPopUpVerbiage(String expTitle, String expMessage, String expiosMessage) {
			try {
				...
				if(device.contentEquals("iOS")) {//added on 22-05-2020
					Assert.assertEquals(actMessage, expiosMessage,"Message is not matching");
				}else {
