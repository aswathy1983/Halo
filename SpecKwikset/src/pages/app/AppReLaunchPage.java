...
public class AppReLaunchPage extends Settings{
	...
	public AppReLaunchPage(AppiumDriver<MobileElement> driver) {
	...
	public void appQuitAndRelaunch() throws InterruptedException {
		try {
			if (device.equals("iOS")) {
				...
				((AppiumDriver<MobileElement>) driver).terminateApp("com.spectrum.giga");
