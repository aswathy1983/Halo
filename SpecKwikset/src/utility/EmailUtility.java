...
public class EmailUtility {
	...
	public static String getTestSummaryReport() {	
		//String site =PropertyUtility.getPropertyTemp("site");
		String site = "Kwikset";
		//String env = PropertyUtility.getPropertyTemp("environment").toUpperCase();
		String env ="QA";
		...
		String mailText = "<table cellspacing=\"0\" cellpadding=\"0\" border=\"1\" style=\"table-layout:fixed;font-size:13px;font-family:arial,sans,sans-serif;border-collapse:collapse;border:1px solid rgb(204,204,204)\">"
				+ "<colgroup><col width=\"249\"><col width=\"143\"></colgroup><tbody>"
				+"<tr style=\"height:21px\"><td style=\"padding:2px 3px;vertical-align:bottom;background-color:rgb(153,153,153)\" align=\"center\"><span style=\"font-family:arial;font-size:small\"><b>Application</b></span><br></td><td  style=\"padding:2px 3px;vertical-align:bottom;background-color:rgb(153,153,153)\" align=\"center\">"
						+ site
						+ "</td></tr>"
				+"<tr style=\"height:21px\"><td style=\"padding:2px 3px;vertical-align:bottom;background-color:rgb(153,153,153)\" align=\"center\"><span style=\"font-family:arial;font-size:small\"><b>Environment</b></span><br></td><td  style=\"padding:2px 3px;vertical-align:bottom;background-color:rgb(153,153,153)\" align=\"center\">"
						+ env
						+ "</td></tr>"
						//
				+ "<tr style=\"height:21px\"><td style=\"padding:2px 3px;vertical-align:bottom;background-color:rgb(153,153,153)\" rowspan=\"1\" colspan=\"2\" align=\"center\"><b>Test Run Summary Report</b></td>"
				+ "</tr><tr style=\"height:21px\"><td style=\"vertical-align:bottom\" align=\"left\"><span style=\"font-family:arial;font-size:small\">Total Tests Run</span><br></td><td  style=\"vertical-align:bottom\" align=\"center\">"
				+ testRun
				+ "</td></tr><tr style=\"height:21px\"><td style=\"vertical-align:bottom\"align=\"left\">"
				...
				+ "<td style=\"vertical-align:bottom\"align=\"left\"><span style=\"font-family:arial;font-size:small\">Tests Failed"
	 ...
	 */
		...
		try {
			...
			for(int i=0;i<emailList.length;i++){
				...
				logFileName = "Test Report.html";
				String fileAttachment = System.getProperty("user.dir")	+ "/test-output-extent/"+Constants.projectName+"_"+Settings.suite+"_Report.html";	
				//logFileName1 = "Load Test Report.csv";
				//String fileAttachment1 = System.getProperty("user.dir")	+ "/loadTestReports/LoadTest.csv";
				...
				if((base.Settings.appType).equals("API")) {
					File file1 =new File (System.getProperty("user.dir")+"/loadTestReports/LoadTest.csv");
					if(file1.exists()) {
				addattachment(message,logFileName,fileAttachment);
				//addattachment(message,logFileName1,fileAttachment1);
					}
					else {
						//no action
					}
	...
	public static void addattachment(MimeMessage message,String filename, String attachmentPath) throws MessagingException {
		messageBodyPart = new MimeBodyPart();
